  ...
  return (
    <section className="py-20 relative overflow-hidden bg-[url('/cta.jpg')] bg-cover bg-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <Link to="/register?role=landlord" className="inline-block bg-secondary hover:bg-green-600 text-white px-10 py-4 rounded-xl font-bold text-xl shadow-xl shadow-green-900/20 transition-all transform hover:-translate-y-1">
          Post a Property
        </Link>
      </div>
    </section>
